            ...
            <Modal.Body>
              ...
              <Graella>
                {reserva.map((resv, indx) => (
                  <Button
                    id={resv.hora}
                    // disabled={resv.ocupada}
                    // variant={resv.ocupada ? "danger" : "outline-primary"}
                    variant={resv.ocupada ? "primary" : "outline-primary"} // resv.variant}
                    className="w-100"
                    // onClick={(e) => handleHora(e.target.id, indx)}
